        ...
        <div className="cover" id="cover">
            ...
            <div className={"infotag " + (QRopen && "active")}>
                <div className="itemContainer">
                    <IconButton onClick={()=>window.location.assign("mailto:yhou63@wisc.edu")}>
                ...
                <div className="itemContainer">
                    <IconButton onClick={()=>window.location.assign("sms:6089492721")}>
                ...
                <div className="itemContainer">
                    <IconButton onClick={()=>window.open("https://github.com/YingzeHou", "_blank")}>
                ...
                <div className="itemContainer">
                    <IconButton onClick={()=>window.open("https://www.linkedin.com/in/yingze-hou-1630971b1/", "_blank")}>
